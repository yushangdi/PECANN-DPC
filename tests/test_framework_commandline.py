...
for density_method in [
    ...
    run_command(
        "./build/dpc_framework_exe  --query_file ./data/gaussian_example/gaussian_4_1000.data \
            --decision_graph_path ./results/gaussian_4_1000.dg --output_file %s \
            --dist_cutoff 8.36 --density_method %s"
        % (output_path, density_method)
    )
